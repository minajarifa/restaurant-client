    ...
    <div>
      ...
      >
        <SwiperSlide>
          ...
          <h1 className="-mt-16 text-4xl text-center text-white uppercase">Sorma</h1>
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-96" src={image2} alt="" />
           <h1 className="mb-6 -mt-16 text-4xl text-center text-white uppercase">Burger</h1>
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-96" src={image3} alt="" />
           <h1 className="mb-6 -mt-16 text-4xl text-center text-white uppercase ">Nun ruti</h1>
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-96" src={image4} alt="" />
           <h1 className="mb-6 -mt-16 text-4xl text-center text-white uppercase ">Frience fry</h1>
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-96" src={image5} alt="" />
           <h1 className="mb-6 -mt-16 text-4xl text-center text-white uppercase ">caomin</h1>
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-96" src={image6} alt="" />
           <h1 className="mb-6 -mt-16 text-4xl text-center text-white uppercase ">Nudooles</h1>
        </SwiperSlide>
      </Swiper>
    </div>
  );
